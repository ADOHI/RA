...
public class CameraController : MonoBehaviour {
	...
	void Update()
	{
        transform.localRotation = Quaternion.LerpUnclamped(transform.localRotation, new Quaternion(InputQueueManager.Instance.iq.x, -InputQueueManager.Instance.iq.z, InputQueueManager.Instance.iq.y, InputQueueManager.Instance.iq.w), Time.deltaTime * 3f);
        ...
        InputQueueManager.Instance.RotateMirrorImage(new Quaternion(InputQueueManager.Instance.iq.x, -InputQueueManager.Instance.iq.z, InputQueueManager.Instance.iq.y, InputQueueManager.Instance.iq.w));
    }
	...
	{
        //_horizontalInput = ;
        return new Vector2(InputQueueManager.Instance.inputZ, -InputQueueManager.Instance.inputY);
